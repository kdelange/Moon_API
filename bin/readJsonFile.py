...
parser.add_argument('--inn', help='txt file with patient and parent information')
		...
		for sample_dict in data['samples']:
			...
			if sample_dict['name'] == fatherID:
				...
				with open(args.outt, 'a') as outfile:
					if header == False:
						outfile.write('file,gender,project_id,age,hpo_termen,mother,mother_healt,father,father_health,motherID,fatherID'+'\n')
						header = True
